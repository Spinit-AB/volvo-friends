...
export const AwaitedBecomeMember = ({
  ...
  return (
    <>
      <div className="footer-theme-red" />
      <Header title={t("member.page_title")} color={"red"} />
      <div className={`page-container ${styles.firstSection}`}>
        <p>
      ...
      >
        ...
        <ul>
          <li>
            Du stödjer vår förening Volvo Friends och dess aktiviteter genom din
            medlemsavgift
          </li>
          <li>
            Du har möjlighet att ytterligare stödja föreningen och Volvobolagen
            genom att aktivt deltaga som guide/instruktör/tekniker i samband med
            vissa arrangemang och/eller underhåll av World of Volvo eller
            Volvobolagens veteranfordon, bistå i Volvos Historiska Arkiv m.m.
          </li>
        </ul>
      </section>
      <section
      ...
      >
        ...
        <ul>
          <li>
            Du och din partner har samma förmåner som den enskilde medlemmen för
            en rabatterad gemensam medlemsavgift.
          </li>
        </ul>
      </section>
      ...
      <section className="page-container" aria-describedby="fee-heading">
